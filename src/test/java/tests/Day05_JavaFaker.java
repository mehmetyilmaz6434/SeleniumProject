...
public class Day05_JavaFaker { //mvnrepository'den javafaker kodunu aldık ve pom.xml' e yapıştırdık.

   /*
TEST DATA : username, password, URL, test environment, city, ssn,...
-Where do you get your test data?  ==>test yapılacak data
...
//        email
        ...
        //random digit number
        String randomDigitNumber=faker.number().digits(10);
        System.out.println(randomDigitNumber);
